...
INSERT INTO `class_setting` (`setting_id`, `type_id`, `setting_title`, `setting_value`, `value_type`, `display_order`, `class_id`, `status_id`, `description`) VALUES
...
(11, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 2, 1, 'Stduent need to attend'),
(12, 31, '% Minimum attendance', '80', 'number', 'ASC', 2, 1, '% Minimum attendance'),
(13, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 3, 1, 'Video intro for class'),
(14, 32, 'Student can vote', 'true', 'boolean', 'DESC', 3, 1, 'Student can vote comment'),
(15, 32, 'Student can comment', 'true', 'boolean', 'DESC', 3, 1, 'Studen can commentss'),
(16, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 3, 1, 'Stduent need to attend'),
(17, 31, '% Minimum attendance', '80', 'number', 'ASC', 3, 1, '% Minimum attendance'),
(18, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 4, 1, 'Video intro for class'),
(19, 32, 'Student can vote', 'true', 'boolean', 'DESC', 4, 1, 'Student can vote comment'),
(20, 32, 'Student can comment', 'true', 'boolean', 'DESC', 4, 1, 'Studen can commentss'),
(21, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 4, 1, 'Stduent need to attend'),
(22, 31, '% Minimum attendance', '80', 'number', 'ASC', 4, 1, '% Minimum attendance'),
(23, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 5, 1, 'Video intro for class'),
(24, 32, 'Student can vote', 'true', 'boolean', 'DESC', 5, 1, 'Student can vote comment'),
(25, 32, 'Student can comment', 'true', 'boolean', 'DESC', 5, 1, 'Studen can commentss'),
(26, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 5, 1, 'Stduent need to attend'),
(27, 31, '% Minimum attendance', '80', 'number', 'ASC', 5, 1, '% Minimum attendance'),
(28, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 6, 1, 'Video intro for class'),
(29, 32, 'Student can vote', 'true', 'boolean', 'DESC', 6, 1, 'Student can vote comment'),
(30, 32, 'Student can comment', 'true', 'boolean', 'DESC', 6, 1, 'Studen can commentss'),
(31, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 6, 1, 'Stduent need to attend'),
(32, 31, '% Minimum attendance', '80', 'number', 'ASC', 6, 1, '% Minimum attendance'),
(33, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 7, 1, 'Video intro for class'),
(34, 32, 'Student can vote', 'true', 'boolean', 'DESC', 7, 1, 'Student can vote comment'),
(35, 32, 'Student can comment', 'true', 'boolean', 'DESC', 7, 1, 'Studen can commentss'),
(36, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 7, 1, 'Stduent need to attend'),
(37, 31, '% Minimum attendance', '80', 'number', 'ASC', 7, 1, '% Minimum attendance'),
(38, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 8, 1, 'Video intro for class'),
(39, 32, 'Student can vote', 'true', 'boolean', 'DESC', 8, 1, 'Student can vote comment'),
(40, 32, 'Student can comment', 'true', 'boolean', 'DESC', 8, 1, 'Studen can commentss'),
(41, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 8, 1, 'Stduent need to attend'),
(42, 31, '% Minimum attendance', '80', 'number', 'ASC', 8, 1, '% Minimum attendance'),
(43, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 9, 1, 'Video intro for class'),
(44, 32, 'Student can vote', 'true', 'boolean', 'DESC', 9, 1, 'Student can vote comment'),
(45, 32, 'Student can comment', 'true', 'boolean', 'DESC', 9, 1, 'Studen can commentss'),
(46, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 9, 1, 'Stduent need to attend'),
(47, 31, '% Minimum attendance', '80', 'number', 'ASC', 9, 1, '% Minimum attendance'),
(48, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 10, 1, 'Video intro for class'),
(49, 32, 'Student can vote', 'true', 'boolean', 'DESC', 10, 1, 'Student can vote comment'),
(50, 32, 'Student can comment', 'true', 'boolean', 'DESC', 10, 1, 'Studen can commentss'),
(51, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 10, 1, 'Stduent need to attend'),
(52, 31, '% Minimum attendance', '80', 'number', 'ASC', 10, 1, '% Minimum attendance'),
(53, 33, 'Video intro', 'https://youtu.be/RgKAFK5djSk', 'string', 'ASC', 11, 1, 'Video intro for class'),
(54, 32, 'Student can vote', 'true', 'boolean', 'DESC', 11, 1, 'Student can vote comment'),
(55, 32, 'Student can comment', 'true', 'boolean', 'DESC', 11, 0, 'Studen can commentss'),
(56, 31, 'Need to take attendance', 'true', 'boolean', 'ASC', 11, 1, 'Stduent need to attend'),
(57, 31, '% Minimum attendance', '80', 'number', 'ASC', 11, 1, '% Minimum attendance');
...
(11, 55, 1, 1, 1, 10, '1', NULL),
(11, 56, 1, 1, 1, 9, 'a', NULL),
(11, 57, 1, 1, 2, 9.5, 'a', NULL);
...
(21, 'Add Subject Setting', '/subject/setting/add'),
...
(42, 3, 'WINTER 2022', '142', '12', 1, 'AAAAAAAAA');
