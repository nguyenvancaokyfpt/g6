...
public interface IssueDao {
    ...
    String orderDir, int classFilter, int teamFilter, int assignFilter, int statusFilter,int supId,int mileFilter) throws SQLException;
    int countAll(Connection connection, int classFilter, int teamFilter)throws SQLException;
    int countFilter(Connection connection,String search, int classFilter, 
            int teamFilter, int assignFilter, int statusFilter, int supId, int mileFilter)throws SQLException;
