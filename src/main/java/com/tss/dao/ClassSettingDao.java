...
public interface ClassSettingDao {
        ...
        int countAll(Connection connection, String search, String typeFilter, String statusFilter, int classId)
                        throws SQLException;
        ...
        void updateClassSetting(Connection connection, int settingId, String value, String description,
                        String displayOrder,
