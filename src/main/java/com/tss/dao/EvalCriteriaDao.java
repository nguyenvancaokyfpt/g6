...
public interface EvalCriteriaDao {
        ...
        List<EvalCriteria> findAll(Connection connection, int start, int length, String search, String columnName,
                        String orderDir, int subjectFilter, int assignFilter, int statusFilter, int userId)
                        throws SQLException;

        int countAll(Connection connection, String search, int subjectFilter, int assignFilter, int statusFilter,
                        int userId)
                        throws SQLException;
