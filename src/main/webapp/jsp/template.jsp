<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<body id="kt_body" data-kt-aside-minimize="on"
		...
		<script>
			"use strict";
			var KTHeaderToolBar = (function () {
				var classSelector = $("#kt-class-selector-global");
				return {
					init: function () {
						classSelector.on('select2:selecting', function (e) {
							axios.get("/?globalClassId=" + e.params.args.data.id).then(function (response) {
