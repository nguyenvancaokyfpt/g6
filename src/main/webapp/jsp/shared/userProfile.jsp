                                ...
                                <div id="kt_content_container" class="container">
                                    ...
                                    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                        ...
                                        <div class="card-header cursor-pointer">
                                            ...
                                            <!--end::Card title-->
                                            <!--begin::Action-->
                                            <a href="profile?userId=2&action=update" class="btn btn-primary align-self-center">Edit Profile</a>
                                            <!--end::Action-->
                                        </div>
                                        <!--begin::Card header-->
                                        <!--begin::Card body-->
...
<!--                                            <div class="row mb-7">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    <span class="fw-bold fs-6"><%--client.getCompany()--%></span>
                                                </div>
                                                end::Col
                                            </div>-->
                                            <!--end::Input group-->
<!--                                             <div class="row mb-7">
                                                ...
                                                begin::Col
                                                <div class="col-lg-8 fv-row">
                                                    <span class="fw-bold fs-6"><%--client.getPosition()--%></span>
                                                </div>
                                                end::Col
                                            </div>-->
                                           <!--begin::Input group-->
                                            <div class="row mb-7">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <span class="fw-bold fs-6"><%=user.getMobile()%></span>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
...
<!--                                            <div class="row mb-7">
                                                ...
                                                begin::Col
                                                <div class="col-lg-8 fv-row">
                                                    <span class="fw-bold fs-6"><%--client.getAddress()--%></span>
                                                </div>
                                                end::Col
                                            </div>-->
                                            <!--end::Input group-->
