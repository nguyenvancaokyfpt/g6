...
<div class="footer py-4 d-flex flex-lg-column" id="kt_footer" style="background-color: #181c2c;">
    ...
    <div
        ...
        <div class="text-gray-100 order-2 order-md-1">
            ...
            <a href="" target="_blank" class="text-gray-100 text-hover-primary">H?i & ?áp</a>
             <span class="text-muted fw-bold me-1">|</span>
            <a href="" target="_blank" class="text-gray-100 text-hover-primary">Chính sách b?o m?t</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Menu-->
        <div class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
             <span class="text-muted fw-bold me-1">K?t n?i v?i chúng tôi</span>
         ...
         <div
             ...
             <div
                 ...
                 <div class="text-light order-2 order-md-1" style="width: 300px;">
                     <h1 class="d-flex align-items-center fw-bolder my-1 fs-3 text-light">??A CH? VÀ THÔNG TIN LIÊN H?</h1>
                     <ul>
                         <li><h5 >Address:</h5> ??i h?c FPT, Km29, ??i l? Th?ng Long, Khu CNC Hòa L?c, Th?ch Hòa, Th?ch Th?t, Hà N?i</li>                         
             ...
             <!--begin::Menu-->
                 <div class="container-fluid d-flex flex-column">
                      <h1 class="d-flex align-items-center text-light fw-bolder my-1 fs-3">Liên h? c?n h? tr? ho?c nh?n thông tin</h1>
                      <input type="text" class="form-control form-control-solid mb-6" placeholder="H? và tên" value="${user.getFullname()}">
                      ...
                      <textarea class="form-control mb-6" rows="2" placeholder="N?i dung c?n trao ??i,liên l?c"></textarea>
                       <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">
                            <span class="indicator-label">G?i thông tin</span>
