    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="aside-menu flex-column-fluid">
                ...
                <c:if test="${permissionHelper.hasGroupPermissions('/class')}">
                    <!-- Class -->
                    <div data-kt-menu-trigger="click"
                         class="menu-item menu-accordion ${screen.getParentPath() == '/class' ? 'show' : ''}">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotone/Shopping/Box2.svg-->
                                <span class="svg-icon svg-icon-2">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            <c:if test="${permissionHelper.hasPermission(ScreenConstants.CLASS_LIST)}">
                                <div class="menu-item ">
                                    <a class="menu-link ${screen == ScreenConstants.CLASS_LIST ? 'active' : ''}"
                                       href="${ScreenConstants.CLASS_LIST.getPath()}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
