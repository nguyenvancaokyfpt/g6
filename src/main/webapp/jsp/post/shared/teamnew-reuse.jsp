                            ...
                            <div class="d-flex flex-wrap justify-content-center">
                                ...
                                <form id="kt_modal_export_users_form" class="form mb-6" action="#">
                                    <div class="mb-13 text-center">
                                        <!--begin::Title-->
                                        <h1 class="mb-3">Reuse Team</h1>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="text-gray-400 fw-bold fs-5">
                                            <a class="fw-bolder link-primary">Select Team you want to reuse</a>.
                                        </div>
                                        <!--end::Description-->
                                    </div>
                                    <!--begin::Input group-->
                                        ...
                                        <div class="dropzone" id="kt_modal_create_project_settings_logo">
                                            ...
                                            <div class="dz-message needsclick">
                                                ...
                                                <div class="ms-4">
                                                    ...
                                                    <span class="fw-bold fs-4 text-gray-400">Reuse all the team
                                                        members, tasks,<br /> and assignments from the selected
                                                        milestone
                                                </div>
                                                <!--end::Info-->
                                            </div>
