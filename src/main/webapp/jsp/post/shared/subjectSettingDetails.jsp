            ...
            <form id="kt_account_profile_details_form" class="form" action="/subjectSetting" method="post">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <select name="typeId" class="form-select form-select-solid" aria-label="Select example">
                        <option ${ss.typeId == '' ? 'selected' : ''}></option>
                        <option value="1" ${ss.typeId == '1' ? 'selected' : ''}>Marks</option>
                        <option value="2" ${ss.typeId == '2' ? 'selected' : ''}>Learning Progress</option>
                        <option value="3" ${ss.typeId == '3' ? 'selected' : ''}>Lecturers</option>
                        <option value="4" ${ss.typeId == '4' ? 'selected' : ''}>Complexity</option>
                    </select>
                    <br>
                    <h4>Setting Order: </h4>
                    <select name="value" class="form-select form-select-solid" aria-label="Select example">
                        <option ${ss.value == '' ? 'selected' : ''}></option>
                        <option value="1" ${ss.value == '1' ? 'selected' : ''}>Simple</option>
                        <option value="2" ${ss.value == '2' ? 'selected' : ''}>Normal</option>
                        <option value="3" ${ss.value == '3' ? 'selected' : ''}>Complex</option>
                    </select>
                    <br>
                    <div>
