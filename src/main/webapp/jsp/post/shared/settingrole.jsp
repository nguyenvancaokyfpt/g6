            ...
            <div class="col-md-4">
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-footer flex-wrap pt-0">
                        <a href="${ScreenConstants.SETTING_ROLE_PERMISSIONS.getPath()}?action=view" class="btn btn-light btn-active-primary my-1 me-2">View Role</a>
                        <button type="button" class="btn btn-white btn-active-light-primary my-1" data-bs-toggle="modal" data-bs-target="#kt_modal_update_role">Edit Role</button>
                    </div>
                    <!--end::Card footer-->
                </div>
                <!--end::Card-->
