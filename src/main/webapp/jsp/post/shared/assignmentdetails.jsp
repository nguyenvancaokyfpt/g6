                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-8 justify-content-center">
                            ...
                            <div class="col-xl-3 fv-row">
                                <input type="text" class="form-control itemHidden" name="assign_name"
                                    placeholder="Type Criterial Name" value="${requestScope.assign.title}" />
                        ...
                        <div class="row mb-8 justify-content-center">
                            ...
                            <div class="col-xl-3 fv-row">
                                <input type="number" min="1" max="100"
                                    class="form-control itemHidden" name="assign_weight"
