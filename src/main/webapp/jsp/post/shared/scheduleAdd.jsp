        ...
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            ...
            <div class="card">
                ...
                <div class="card-body p-12">
                    <!--begin::Form-->
                    <form action="/schedule/list?action=create" id="kt_invoice_form" method="post">
                        <!--begin::Wrapper-->
                        <div class="d-flex flex-column align-items-start flex-xxl-row">
                            <!--begin::Input group-->
                            <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip">
                                <span class="fs-2x fw-bolder text-gray-800">Add Schedule</span>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Top-->
                        ...
                        <div class="mb-0">
                            ...
                            <div class="row gx-10 mb-5">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-5">
                                        ...
                                        <select required class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                            ...
                                            <option value="1">Slot 1 (7:30 - 9:00)</option>
                                            <option value="2">Slot 2 (9:10 - 10:40)</option>
                                            <option value="3">Slot 3 (10:50 - 12:20)</option>
                                            <option value="4">Slot 4 (12:50 - 14:20)</option>
                                            <option value="5">Slot 5 (14:30 - 16:00)</option>
                                            <option value="6">Slot 6 (16:10 - 17:40)</option>
                                        </select>
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <select required class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                            ...
                                            <c:forEach items="${requestScope.classes}" var="cl">
                                                <option value="${cl.classId}">${cl.classCode}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input name="room" value="" required type="text" class="form-control form-control-solid" placeholder="Room" />
                                    </div>
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="mb-0">
                                ...
                                <input name="title" value="" required name="notes" class="form-control form-control-solid" rows="3" placeholder="Title for schedule"/>
                            </div>
                            <!--end::Notes-->
