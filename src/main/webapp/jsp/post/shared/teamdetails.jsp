                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-8 justify-content-center">
                        ...
                        <div class="col-xl-3 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid itemHidden" name="team_project"
                                   placeholder="Type Criterial Name" value="${requestScope.team.project_code}" required />
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row mb-8 justify-content-center">
                        ...
                        <!--begin::Col-->
                        <div class="col-xl-3 fv-row">
                            <input type="text" class="form-control form-control-solid itemHidden" name="team_topicName"
                                   placeholder="Type Criterial Name" value="${requestScope.team.topic_name}"
                                   required />
                            <input type="text" class="form-control form-control-solid itemShow" disabled
                        ...
                        <div class="col-xl-3 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid itemHidden" name="team_topicCode"
                                   placeholder="Type Criterial Name" value="${requestScope.team.topic_code}"
                                   required />
                        </div>
                        <!--end::Col-->
                    </div>
                            ...
                            <div class="d-flex fw-bold">
                                <div style="display: none;"
                                    ...
                                    <input class="form-check-input" type="radio" value="1" name="team_status"
                                           <c:if test="${requestScope.team.status_id ==1}">checked</c:if> />
                                    ...
                                    <div style="display: none;"
                                        ...
                                        <c:if test="${requestScope.team.status_id ==0}">checked</c:if> />
