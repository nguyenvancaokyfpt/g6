			...
			<div class="card-body pt-9 pb-0">
				...
				<div class="d-flex overflow-auto h-55px">
					<ul
						...
						<!--begin::Nav item-->
						<li class="nav-item">
							<a class="nav-link text-active-primary me-6" href="/profile?tab=settings">Settings</a>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
		...
		<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
			...
			<div class="card-body p-9">
				...
				<div class="row mb-7">
					...
					<!--begin::Col-->
					<div class="col-lg-8">
						<span class="fw-bolder fs-6 text-dark">${user.getFullname()}</span>
					</div>
					<!--end::Col-->
				</div>
				<!--end::Row-->
				...
				<div class="row mb-7">
					...
					<div class="col-lg-8 fv-row">
						<span class="fw-bold fs-6">Metronic</span>
					</div>
					<!--end::Col-->
				</div>
				<!--end::Input group-->
				...
				<div class="row mb-7">
					...
					<div class="col-lg-8 d-flex align-items-center">
						<span class="fw-bolder fs-6 me-2">${user.getMobile()}</span>
				...
				<div class="row mb-7">
					...
					<!--begin::Col-->
					<div class="col-lg-8">
						<a href="#" class="fw-bold fs-6 text-dark text-hover-primary">nguyenvancaoky.tech</a>
					</div>
					<!--end::Col-->
				</div>
				<!--end::Input group-->
