                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-8 justify-content-center">
                            ...
                            <div class="col-xl-3 fv-row">
                                ...
                                <select id="userRole" class="form-select form-select-solid itemHidden"
                                    aria-label="Select example">
                                    <c:forEach items="${requestScope.roles}" var="r">
                                        <option value="${r.id}" <c:if test="${r.id == user.role.id}">selected</c:if>
                                            >${r.title}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        ...
                        <div class="row mb-8 justify-content-center">
                            ...
                            <div class="col-xl-3 fv-row">
                                ...
                                <input id="userMobile" type="text" class="form-control form-control-solid itemHidden"
                                    name="user_topicCode" placeholder="Type mobile" value="${requestScope.user.mobile}"
                                    required />
                            </div>
                            <!--end::Col-->
                        </div>
                                ...
                                <div class="d-flex fw-bold">
                                    <div style="display: none;"
                                        ...
                                        <input id="userStatus" class="form-check-input" type="radio" value="1"
                                            name="user_status" <c:if test="${requestScope.user.statusId ==1}">checked
                                        </c:if> />
