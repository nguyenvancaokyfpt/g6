                        ...
                        <button type="button" class="btn btn-primary mb-3"
                                ...
                                onclick="
                                        list(getSearchRg(),
                                                ...
                                                getStatusFilter(), '${requestScope.sort}', '1')
                                ">
                            Search
                        </button>
                    </div>
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px d-flex">
                                ...
                                <div>
                                    <i style="font-size: 18px; ${requestScope.sort == 'asc' ? 'color: #009ef7;' : ''}" 
                                       class="fa fa-angle-up"
                                       onclick="
                                               list(getSearchRg(),
                                                       getSubjectFilter(),
                                                       getDisplayOrderFilter(),
                                                       getStatusFilter(), 'asc', '1')
                                       ">
                                    </i>
                                    <i style="font-size: 18px; ${requestScope.sort == 'desc' ? 'color: #009ef7;' : ''}" 
                                       class="fa fa-angle-down"
                                       onclick="
                                               list(getSearchRg(),
                                                       getSubjectFilter(),
                                                       getDisplayOrderFilter(),
                                                       getStatusFilter(), 'desc', '1')
                                       ">
                                    </i>
                                </div>
                            </th>
                                    ...
                                    <button class="page-link"
                                            onclick="
                                                    list(getSearchRg(),
                                                            getSubjectFilter(),
                                                            getDisplayOrderFilter(),
                                                            getStatusFilter(), '${requestScope.sort}', '${p}')
                                            ">
                                        ${p}
                                    </button>
                                </li>
...
<form hidden id="formList" action="/subject/setting" method="post">
...
<form hidden id="formChangeStatus" action="/subject/setting" method="post">
    <input name="action" value="changeStatus"/>
    <input name="settingId" value="" id="settingIdInp"/>
</form>

<form hidden id="formDetails" action="/subject/setting" method="post">
...
<script type="text/javascript">
    ...
    function list(search, subjectFilter, displayOrderFilter, statusFilter, sort, pageNo) {
        ...
        document.getElementById('sortInp').value = sort;
