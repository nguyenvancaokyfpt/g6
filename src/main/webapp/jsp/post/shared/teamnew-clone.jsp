                            ...
                            <div class="d-flex flex-wrap justify-content-center">
                                ...
                                <form id="kt_modal_export_users_form" class="form mb-6" action="#">
                                    <div class="mb-13 text-center">
                                        <!--begin::Title-->
                                        <h1 class="mb-3">Clone Team</h1>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="text-gray-400 fw-bold fs-5">
                                            <a class="fw-bolder link-primary">Select Team you want to Clone</a>.
                                        </div>
                                        <!--end::Description-->
                                    </div>
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-10">
                                        ...
                                        <div class="fv-row mb-10 mt-10">
                                            ...
                                            <label class="required fs-6 fw-bold form-label mb-2">Select
                                                Team of Milestone:</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select name="milestoneOldId" data-control="select2"
                                    ...
                                    <div class="fv-row mb-8">
                                        ...
                                        <div class="dropzone" id="kt_modal_create_project_settings_logo">
                                            ...
                                            <div class="dz-message needsclick">
                                                ...
                                                <!--begin::Info-->
                                                <div class="ms-4">
                                                    <h3 class="dfs-6 fw-bolder text-gray-900 mb-1">This action will</h3>
                                                    <span class="fw-bold fs-4 text-gray-400">Clone all the team
                                                        members to new<br /> selected milestone</span>
                                                </div>
                                                <!--end::Info-->
                                            </div>
                                        </div>
