                                ...
                                <form action="/classlist">
                                    ...
                                    <div class="modal-body py-10 px-lg-17" >
                                        ...
                                        <div class="d-flex flex-column mb-5 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" placeholder="Enter setting title" name="class_code" required="true" value="<%=sd.getClass_code()%>">
                                            <!--end::Input-->
                                            ...
                                            <select class="form-select form-select-solid fw-bolder select2-hidden-accessible" data-kt-select2="true" data-placeholder="Select supporter" aria-hidden="true" name="supporter_id" required="true">
                                                ...
                                                <c:forEach items="${supporterList}" var="sl">
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <option value="${sl.trainer_id}">${sl.trainerString}</option>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </c:forEach>                                                                    
                                            </select>
                                        ...
                                        <div class="">
                                            ...
                                            <% } else { %>
                                            <input class="form-check-input" type="radio" id="html" name="status_id" value="0" checked="true">
                                            <label for="0" class="form-label fw-bolder text-dark fs-6">Inactive</label>
                                            <input class="form-check-input" type="radio" id="css" name="status_id" value="1">
                                            <label for="1" class="form-label fw-bolder text-dark fs-6">Active</label>
                                            <% } %> 

                                            <div class="fv-plugins-message-container invalid-feedback"></div></div><br>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="d-flex flex-column mb-5 fv-row fv-plugins-icon-container">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea class="form-control form-control-solid" placeholder="Enter description" name="description"><%=sd.getDescription()%></textarea>
                                            <!--end::Input-->
                                            <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                        <!--end::Input group-->
