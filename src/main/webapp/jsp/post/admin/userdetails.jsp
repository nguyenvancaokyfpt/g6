                    ...
                    <div class="card-body pt-0 pt-lg-1">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body d-flex flex-center flex-column pt-12 p-9 px-0">
                                ...
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">${requestScope.user.fullname}</a>
                                <!--end::Name-->
                                <!--begin::Position-->
                                <div class="mb-9">
                                    <!--begin::Badge-->
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600">
                                    <a href="#" class="text-gray-600 text-hover-primary">${requestScope.user.email}</a>
                                </div>
                                <!--begin::Details item-->
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                <!--begin::Content-->
                                <div class="fw-bold">
                                    <div class="fs-6 text-gray-600">By connecting an account, you hereby agree to our
                                                ...
                                                <td>
                                                    <c:choose>
                                                        ...
                                                        <c:when test = "${requestScope.user.statusId == 1}">
                                                            <div class="d-flex"><button type="button" class="btn btn-success">Activate</button></div>
                                                        </c:when>

                                                        <c:when  test = "${requestScope.user.statusId == 0}">
                                                            <div class="d-flex "><button type="button" class="btn btn-danger">Deactivate</button></div>
                                                        </c:when>
                                                    </c:choose>
                                                </td>
                                                <td class="text-end">
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-title flex-column">
                                    ...
                                    <div class="fs-6 fw-bold text-gray-400">Keep your account extra secure with a second
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-title flex-column">
                                    ...
                                    <div class="fs-6 fw-bold text-gray-400">Choose what messages you’d like to receive
                                ...
                                <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Event=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2021, 11:30 am
                                            </td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Event=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2021, 11:05 am
                                            </td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Event=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2021, 11:30 am
                                            </td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                        ...
                        <form id="kt_modal_update_role_form" class="form" action="#">
                            ...
                            <div
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <!--begin::Content-->
                                    <div class="fw-bold">
                                        <div class="fs-6 text-gray-600">Please note that reducing a user role rank, that
