                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    ...
                                    <form id="kt_modal_add_user_form" class="form"
                                        action="/management/user?action=create" method="post">
                                        <!--begin::Scroll-->
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <label
                                                        ...
                                                        <input type="hidden" name="avatar_remove"
                                                            value="assets/media/avatars/150-9.jpg" />
                                                        <!--end::Inputs-->
                                                    </label>
                                                    <!--end::Label-->
                                                    <!--begin::Cancel-->
                                            ...
                                            <div class="mb-7">
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <input class="form-check-input me-3" name="user_role"
                                                            type="radio" value="21" id="kt_modal_update_role_option_0"
                                                            checked='checked' />
                                                        <!--end::Input-->
                                                        <!--begin::Label-->
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="text-gray-600">Lorem ipsum dolor sit amet,
                                                                consectetur adipisicing elit. Animi, eum voluptas!
                                                                Aspernatur libero facere repellat animi commodi aperiam
                                                                expedita corrupti.</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="text-gray-600">Lorem ipsum dolor sit amet
                                                                consectetur adipisicing elit. Quis commodi reprehenderit
                                                                pariatur quia totam alias id minima voluptates.</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="fw-bolder text-gray-800">EXPERT</div>
                                                            <div class="text-gray-600">Lorem ipsum dolor sit amet
                                                                consectetur adipisicing elit. Quasi dolorem fugit
                                                                expedita, incidunt voluptas consequatur.</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="fw-bolder text-gray-800">TRAINER</div>
                                                            <div class="text-gray-600">Lorem ipsum dolor sit amet
                                                                consectetur adipisicing elit. Optio, eveniet?</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="fw-bolder text-gray-800">SUPPORTER</div>
                                                            <div class="text-gray-600">Lorem ipsum dolor sit amet
                                                                consectetur adipisicing elit. Nihil doloribus quas
                                                                adipisci?</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="kt_modal_update_role_option_4">
                                                            <div class="fw-bolder text-gray-800">STUDENT</div>
                                                            <div class="text-gray-600">Lorem ipsum dolor sit amet
                                                                consectetur adipisicing elit. Quod facere nemo aut
                                                                minus? Possimus magni maiores officiis placeat aperiam
                                                                quia vel aliquid?</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="user_note"
                                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                                    placeholder="Something about?" value="" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
