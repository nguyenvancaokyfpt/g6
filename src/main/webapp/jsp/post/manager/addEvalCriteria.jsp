                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-xl-9 fv-row">
                            <input type="text" class="form-control form-control-solid" name="criteria_name" placeholder="Type Criterial Name" />
                        </div>
                    </div>
                    <!--end::Row-->
                    <!--begin::Row-->
                    ...
                    <div class="row mb-8">
                        ...
                        <!--begin::Col-->
                        <div class="col-xl-9 fv-row">
                            <textarea name="criteria_description" class="form-control form-control-solid h-100px" placeholder="Type something for description....."></textarea>
                        </div>
                        <!--begin::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row mb-8">
                        ...
                        <!--begin::Col-->
                        <div class="col-xl-9 fv-row">
                            <input type="number"  min="1" max="100" class="form-control form-control-solid" name="criteria_weight" placeholder="Type number of weight (%)" />
                        </div>
                    </div>
                    <!--end::Row-->
                    <!--begin::Row-->
                    <div class="row">
                        ...
                        <!--begin::Col-->
                        <div class="col-xl-9 fv-row">
                            <input type="number" class="form-control form-control-solid" name="criteria_loc" placeholder="Type Criterial Name" />
                        </div>
                    </div>
                    <!--end::Row-->
                </div>
