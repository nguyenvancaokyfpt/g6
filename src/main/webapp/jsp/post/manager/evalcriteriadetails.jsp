                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-xl-9 fv-row">
                                        ...
                                        <select class="form-select itemHidden" name="criteria_assign">
                                            <c:forEach items="${requestScope.assigns}" var="a">
                                                <option value="${a.assId}" 
                                                        <c:if test="${a.assId == requestScope.assign.assId}">selected</c:if>        
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-xl-9">
                                        <div class="d-flex fw-bold">
                                            ...
                                            <input type="text" class="form-control form-control-solid itemShow" disabled
                                            <c:if test="${requestScope.eval.isTeam ==1}">value="Group"</c:if>
                                    ...
                                    <div class="row mb-8">
                                        ...
                                        <div class="col-xl-9 fv-row">
                                            <input type="number" min="1" max="100"
                                                   class="form-control form-control-solid itemHidden"
                                                   name="criteria_weight" placeholder="Type number of weight (%)"
                                ...
                                <div class="row mb-8">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-9 fv-row">
                                        <input type="number" class="form-control form-control-solid itemHidden"
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-xl-9">
                                        <div class="d-flex fw-bold">
                                            ...
                                            <input type="text" class="form-control form-control-solid itemShow" disabled
                                            <c:if test="${requestScope.eval.status ==1}">value="Active"</c:if>
