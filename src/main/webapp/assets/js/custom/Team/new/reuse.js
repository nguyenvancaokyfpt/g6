...
var KTTeamUpload = (function () {
  ...
  var classSelector = $('[name="milestoneOldId"]');
  return {
    init: function () {
      ...
      discardBtn.addEventListener("click", function (e) {
        ...
        $('[name="milestoneOldId"]').val("").trigger("change");
      });
      submitBtn.addEventListener("click", function (e) {
        e.preventDefault();
        const milestoneId = $('[name="milestoneId"]').val();
        const classId = $('[name="classId"]').val();
        const milestoneOldId = $('[name="milestoneOldId"]').val();
        if (milestoneId == "" || milestoneOldId == "") {
          $.toast({
            heading: "Error",
        ...
        if (milestoneOldId == milestoneId) {
          $.toast({
            heading: "Error",
            text: "Please select different milestone!",
            showHideTransition: "slide",
            icon: "error",
            position: "bottom-right",
          });
        ...
        Swal.fire({
          title: "Are you sure?",
          text: "Current team of milestone will be deleted! You won't be able to revert this!",
          icon: "warning",
      ...
      resetBtn.addEventListener("click", function (e) {
        e.preventDefault();
        const milestoneId = $('[name="milestoneOldId"]').val();
        const classId = $('[name="classId"]').val();
        if (milestoneId == "") {
          $.toast({
            heading: "Error",
