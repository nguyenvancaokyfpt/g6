...
var KTTeamUpload = (function () {
  ...
  return {
    init: function () {
      $('[data-control="select2-num"]').select2({
        tags: true,
        placeholder: "de",
        allowClear: true,
      });
      ...
      submitBtn.addEventListener("click", function (e) {
        ...
        if (teamNum == "") {
          $.toast({
            heading: "Error",
            text: "Please select team number!",
            showHideTransition: "slide",
            icon: "error",
            position: "bottom-right",
          });
        ...
        Swal.fire({
          title: "Are you sure?",
          text: "Current team will be deleted! if you want to continue, please click yes!",
          icon: "warning",
